...
void PORT_init (void)
{
	...
	//PORTB_PCR2 &= ~((0b111)<<MUX_BITS);	/* PORT B14: MUX = ALT3 (LPSPI1_SCK) */
	//PORTB_PCR2 |= ((0b011)<<MUX_BITS);
	//PORTB_PCR3 &= ~((0b111)<<MUX_BITS);	/* PORT B15: MUX = ALT3 (LPSPI1_SIN) */
	//PORTB_PCR3 |= ((0b011)<<MUX_BITS);
	//PORTB_PCR4 &= ~((0b111)<<MUX_BITS);	/* PORT B16: MUX = ALT3 (LPSPI1_SOUT) */
	//PORTB_PCR4 |= ((0b011)<<MUX_BITS);
	//PORTB_PCR5 &= ~((0b111)<<MUX_BITS);	/* PORT B17: MUX = ALT3 (LPSPI1_PCS3) */
	//PORTB_PCR5 |= ((0b011)<<MUX_BITS);
